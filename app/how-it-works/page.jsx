  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-gray-900 mb-12">How AI Mockster Works</h1>
        ...
        <div className="space-y-12">
          <div className="flex items-center space-x-8">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Sign Up and Create Your Profile</h2>
          ...
          <div className="flex items-center space-x-8">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Choose Your Interview Type</h2>
          ...
          <div className="flex items-center space-x-8">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Practice with AI Interviewer</h2>
          ...
          <div className="flex items-center space-x-8">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Receive Detailed Feedback</h2>
